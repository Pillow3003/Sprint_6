...
from utils.locators import YaScooterOrderPageLocators
...
class TestYaScooterOrderPage:
    ...
    def test_order_page_first_name_input_incorrect_show_error_message(self, driver):
        ...
        assert ya_scooter_order_page.find_element(YaScooterOrderPageLocators.INCORRECT_FIRST_NAME_MESSAGE).is_displayed()
    ...
    def test_order_page_last_name_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_order_page.go_next()
        assert ya_scooter_order_page.find_element(YaScooterOrderPageLocators.INCORRECT_LAST_NAME_MESSAGE).is_displayed()
    ...
    def test_order_page_address_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_order_page.go_next()
        assert ya_scooter_order_page.find_element(YaScooterOrderPageLocators.INCORRECT_ADDRESS_MESSAGE).is_displayed()
    ...
    def test_order_page_subway_input_empty_show_error_message(self, driver):
        ...
        ya_scooter_home_page.click_cookie_accept()
        ya_scooter_order_page.go_next()
        assert ya_scooter_order_page.find_element(YaScooterOrderPageLocators.INCORRECT_SUBWAY_MESSAGE).is_displayed()
    ...
    def test_order_page_telephone_number_input_incorrect_show_error_message(self, driver):
        ...
        ya_scooter_order_page.go_next()
        assert ya_scooter_order_page.find_element(YaScooterOrderPageLocators.INCORRECT_TELEPHONE_NUMBER_MESSAGE).is_displayed()
    ...
    def test_order_page_go_to_choose_scooter_user_data_correct_open_about_rent(self, driver):
        ...
        ya_scooter_order_page.go_next()
        assert len(ya_scooter_order_page.find_elements(YaScooterOrderPageLocators.ORDER_BUTTON)) > 0
    ...
    def test_order_page_about_rent_input_correct_data_and_order_show_order_number(self, driver, data_set):
        ...
        assert len(ya_scooter_order_page.find_elements(YaScooterOrderPageLocators.ORDER_COMPLETED_INFO)) > 0
