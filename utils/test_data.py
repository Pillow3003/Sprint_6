class YaScooterHomePageFAQ:
    """
    Хранит часто задаваемые вопросы и ответы на домашней странице.
    """
...
class YaScooterOrderPageData:
    """
    Набор примерных данных для заполнения формы заказа.
    """
    data_sets = {
        'data_set1': {
            'first_name': 'Тест',
            ...
            'subway_name': 'Беговая',
            'telephone_number': '79164136022',  # исправлена опечатка
            'date': '19.02.2024',
            'rental_period': 0,
            'color': [0],
        ...
        'data_set2': {
            ...
            'subway_name': 'Лубянка',
            'telephone_number': '89776545277',  # исправлена опечатка
            'date': '20.02.2024',
            'rental_period': 1,
            'color': [0, 1],
